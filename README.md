...
- Structured context > bigger models  
...
- Agent Memory Architecture (store / retrieve / expire context)  
- LLM Systems (ReAct, GraphRAG, DAG workflows)  
- Scalable backend systems & infrastructure for AI
  
>I’m open to working on **AI systems, infra-heavy builds, or experimental ideas**.  
If you have something interesting, let’s build it.  
...
![Google_Gemini](https://img.shields.io/badge/Gemini-4285F4?style=flat&logo=google)
